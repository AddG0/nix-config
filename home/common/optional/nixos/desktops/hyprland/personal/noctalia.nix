...
in {
  ...
  # Systemd service deprecated upstream — launch via Hyprland exec-once.
  # Recovery-reload firing handled by autostart.nix; on healthy reloads the
  # relauncher exits early so no wrapper guard is needed here.
