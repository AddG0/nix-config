...
1. Read existing ADRs in `docs/adr/` for prior decisions
2. Read `docs/steering/tech.md` and `structure.md` if they exist, else `CLAUDE.md` and the build files
...
3. **Write ADRs** — significant decisions get an ADR at `docs/adr/ADR-NNN-title.md` (see the architecture-standards skill for template and process)
