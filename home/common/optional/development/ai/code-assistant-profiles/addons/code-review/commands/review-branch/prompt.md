...
2. **Filter issues using the progressive threshold table below** - Higher impact issues require less confidence to pass:
   ...
   | 41-60 (Medium) | 80 | Medium issues need high confidence to justify reporting |
   | 21-40 (Medium-Low) | 90 | Lower impact issues need very high confidence |
   | 0-20 (Low) | 100 | Only report low impact issues when absolutely certain |

3. Filter out any issue that does not meet the minimum confidence threshold for its impact band.
