...
1. Read existing ADRs in `.sdd/decisions/` for prior decisions
...
3. **Write ADRs** — significant decisions get an ADR at `.sdd/decisions/ADR-NNN-title.md` (see the architecture-standards skill for template and process)
